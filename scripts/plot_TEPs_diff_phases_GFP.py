...
def plot_teps(filename):
    ...
    fig = plot_TEPs_per_phases_GFP(TEP_pre, TEP_im, TEP_post, time, ms_to_samples)

    fl = os.path.basename(filename)
    fig.suptitle(fl)
    
    output_filename = os.path.join(r"./results/TEPs_differentPhases/3cond_GFP", "GFP_"+os.path.splitext(fl)[0]+".png")
